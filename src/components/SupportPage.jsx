    ...
    return (
        <div className="support-page">
            <header className="support-page__header">
                ...
                <p className="support-page__subtitle">We're here to help! Browse our FAQs or contact us directly.</p>
            </header>
            ...
            <div className="support-page__content">
                <section className="support-page__faq">
                    ...
                    <div className="support-page__faq-list">
                        <article className="support-page__faq-item">
                            ...
                            <p className="support-page__faq-answer">Click on the "Get Started" button on the top-right corner and follow the instructions.</p>
                        </article>
                        <article className="support-page__faq-item">
                            <h3 className="support-page__faq-question">How do I send a request?</h3>
                            <p className="support-page__faq-answer">Go to the "Send a Request" page, fill out the form, and submit your request. (You need to be signed in)</p>
                        </article>
                        <article className="support-page__faq-item">
                            <h3 className="support-page__faq-question">How can I browse the service providers?</h3>
                            <p className="support-page__faq-answer">You can browse the categories on top of the page, select a service, and check the registered craftspeople, or by using the search page.</p>
                        </article>
                    </div>
                </section>
                ...
                <div className={`support-page__modal-overlay ${isModalOpen ? 'support-page__modal-overlay--active' : ''}`}>
                    <div className="support-page__modal">
                        ...
                        <form className="support-page__form" onSubmit={handleSubmit}>
                            ...
                            <button 
                                type="submit" 
                                className="support-page__form-submit"
                            >
                                Submit
                            </button>
                        </form>

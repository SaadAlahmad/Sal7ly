...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2025 at 01:24 AM
...
CREATE TABLE `applications` (
  ...
  `closure_reason` enum('user','system','admin','activation') DEFAULT NULL
...
CREATE TABLE `worksamples` (
  ...
  `file_type` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
